 ...
 * @ingroup Skins
 */
class SkinGMWFreeBlue extends SkinTemplate {
	/** Using gmwfreeblue. */
	var $skinname = 'gmwfreeblue', $stylename = 'gmwfreeblue',
		$template = 'GMWFreeBlueTemplate', $useHeadElement = true;
 ...
 * @ingroup Skins
 */
class GMWFreeBlueTemplate extends QuickTemplate {
	var $skin;
	/**
		...
		<div class="header container_16">
			...
			<div class="grid_8">
                            <div class="portlet logo" id="p-logo">
                                    <a style="background-image: url(<?php  echo $wgScriptPath."/images/openurban_mw_logo.png" ?>);" <?php
...
<div class="wideMainmenu">
	<div class="container_16">
		<div id="p-navigation">
        	<ul>
        		<li>
                	<a href="http://www.openurban.net/OL_process.html">Map</a> 
                </li>
                <li>
                    <a href="/mediawiki/index.php?title=Cities">Cities</a> 
                </li>
                <li>  
                    <a href="/mediawiki/index.php?title=Create_Project">Add Project</a>
                </li>
            </ul>
        </div>
    </div>
